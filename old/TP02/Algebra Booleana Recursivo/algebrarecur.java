...
Ela recebe a String que passou pela simpl, mais duas String incializadas com vazio e um inteiro 
que representa a variacao das posicoes da String. Dentro dessa funcao sao chamadas as outras
nisso vai formando um ciclo, de forma recursiva, ate chegar na resposta, mas nada disso seria possivel
sem a funcao resol que literalmente resolve o exercicio.
*/
public static String algebra ( String x ,String aux, String f , int y )
{
	int tam;
	int z;
	boolean teste = false;	
