...
public class teste {
	...
	public static void main(String[] args) throws Exception {
		...
		while (true) {
			...
			if (s.equals("FIM"))
				...
				// filmeList.inserirInicio(solve(s));
		...
		while (t-- > 0) {
			...
			if (array[0].equals("II")) {
				filmeList.inserirInicio(solve(linha.substring(3, linha.length())));
			}
			else if (array[0].equals("IF")) {
				filmeList.inserirFim(solve(linha.substring(3, linha.length())));
			}
				...
				int k = findIntInString(linha.substring(3, linha.length()));
				filmeList.inserir(solve(linha.substring(6, linha.length())), k);
			}
	...
	public static class Filme {
		...
		public String toString() {
			return nome + ' ' + tituloOriginal + ' ' + new SimpleDateFormat("dd/MM/yyyy").format(dataLancamento) + ' ' + duracao + ' ' + genero + ' ' + idiomaOriginal + ' ' + situacao + ' ' + orcamento + ' ' + Arrays.toString(palavrasChave);
		}
	}
